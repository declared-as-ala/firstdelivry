...
export default function ColisPage() {
  ...
  return (
    <div>
      ...
      {isEmpty ? (
        <EmptyState title="Aucun colis scanné." hint="Scannez les codes-barres First Delivery dans le Scanner pour enregistrer les colis." />
      ) : (
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-200 text-left text-xs uppercase tracking-wide text-slate-400">
                ...
                <th className="px-3 py-2.5 font-medium">Ajout First Delivery</th>
